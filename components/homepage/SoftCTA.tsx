...
export function SoftCTA() {
  ...
  const sectionHeadingClassName = "text-xl font-elegant font-semibold text-ink mb-6";

  if (submitStatus === "success") {
    return (
      <Section>
        <div className="mx-auto max-w-2xl text-center py-16">
          <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-brass/20 flex items-center justify-center">
            <svg className="w-10 h-10 text-brass" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
            </svg>
          </div>
          <Heading eyebrow="Thank You" accent="italic">
            Message Received!
          </Heading>
          <p className="mt-6 text-ink/70 text-lg leading-relaxed">
            We appreciate you reaching out. One of our craftsmen will be in touch within 1-2 business days to discuss your project.
          </p>
          <button
        ...
        <div className="bg-parchment/40 backdrop-blur-sm rounded-2xl border-2 border-umber/20 p-8 md:p-12 shadow-xl">
          <form onSubmit={handleSubmit} className="space-y-12">
            ...
            <div className="space-y-6">
              ...
              {/* Project Type */}
              <div>
                <label className={cn(labelClassName, "mb-4")}>
                  What type of project are you interested in? <span className="text-oxblood">*</span>
                </label>
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          selectedProject === project.id
                            ? "border-brass bg-brass/10 shadow-lg scale-105"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  placeholder="Share your ideas, inspiration, style preferences, dimensions, and any specific requirements. The more details you provide, the better we can help bring your vision to life."
