...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Customer Reviews | Professional Wood Interiors",
    description:
      "5-star reviews from St. Louis homeowners. Read what our clients say about their custom cabinetry projects.",
    type: "website",
  ...
  twitter: {
    ...
    title: "Customer Reviews | Professional Wood Interiors",
    description:
      "5-star reviews from St. Louis homeowners about their custom cabinetry.",
  },
};
...
export default function ReviewsPage() {
  ...
  const reviewSchema = generateReviewListSchema(reviews);
